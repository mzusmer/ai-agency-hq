...
Setup includes GoHighLevel build-out, AI agent configuration, SMS compliance setup, and onboarding call. Retainer covers ongoing automation support, lead follow-up sequences, and optimization.
...
ai-agent/
  missed-call-agent-prompt.md   Full AI agent system prompt
  qualification-questions.md    Questions the agent asks
  response-rules.md             Rules for agent behavior
  handoff-rules.md              When and how to hand off to a human

sales/
  one-page-offer.md          One-page summary of the offer
  pricing.md                 Pricing breakdown and positioning
  cold-email-scripts.md      Cold email templates
  instagram-dm-scripts.md    Instagram DM outreach scripts
  cold-call-script.md        Cold call framework
  loom-audit-script.md       Personalized Loom video script
  objection-handling.md      Responses to common objections
  proposal-template.md       Client proposal template
  follow-up-sequence.md      Multi-touch follow-up cadence
